...
function websdkready() {
  ...
  var SDK_KEY = "X65aXM8sS5iv_Elx9eyiJQ";
  /**
   ...
   */
  var SDK_SECRET = "INEC0oNLqgLpnPHK7SlwXZISDDpvIzwwQRDh";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/xampp/htdocs/myhospital/hms/zoom/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/xampp/htdocs/myhospital/hms/zoom/meeting.html?" +
